@echo off
cd /d "%~dp0"
title Elestial Jumpscare Mod - Multi-Client Test Launcher (4 Players)
echo ====================================================================
echo 🎮 MEMBUKA 4 CLIENT MINECRAFT FORGE UNTUK TES MULTIPLAYER 🎮
echo ====================================================================
...
echo [1/4] Membuka Client 1 (Host / Dev)...
